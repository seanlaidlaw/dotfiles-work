...
plugins=(vi-mode git zsh-256color zsh-autosuggestions fast-syntax-highlighting history-search-multi-word zsh-autopair undollar you-should-use extract history-substring-search gnu-utils zsh-command-note thefuck zsh-z expand-ealias)
